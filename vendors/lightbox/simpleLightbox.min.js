    ...
    return (
        ...
        a.extend(b.prototype, {
            ...
            prepareItem: function (b, c) {
                var d = this,
                    e = this.items[b];
                var meta_data = d.$items[b].children[1];
                if ((this.loading(!0), this.options.videoRegex.test(e))) c.call(d, a('<div class="slbIframeCont"><iframe class="slbIframe" frameborder="0" allowfullscreen src="' + e + '"></iframe></div>'));
                	...
                	console.log(meta_data.innerHTML);
                    var f = a('<div class="slbImageWrap"><img class="slbImage" src="' + e + '" /></div><div class="meta_data">'+meta_data.innerHTML+'</div>');
            ...
            setupLightboxEvents: function () {
                ...
                this.lightboxEventsSetuped ||
                    (this.$el.on("click" + this.ens, function (c) {
                        var d = a(c.target);
                        d.is(".slbCloseBtn") || (b.options.closeOnOverlayClick && d.is(".slbWrap"))
                            ? b.close()
                            : d.is(".slbArrow")
                            ? d.hasClass("next")
                                ? b.next()
                                : b.prev()
                            : b.options.nextOnImageClick && b.items.length > 1 && d.is(".slbImage") && b.next();
                    }),
